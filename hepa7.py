...
import sys
import sqlite3
from hpzok7 import Ui_Dialog  # Adjust the import based on your file structure
from Di_not import Ui_NDialog  # Adjust the import based on your file structure
from hm7 import UI_Main  # Assuming this is a QMainWindow or similar
...
class UI_PatientsWindow(QMainWindow):
    ...
    def clicker_display(self):
        ...
        conn = sqlite3.connect('/home/mahdi/project/formdb/fo11.db')  # Use the full path
        cur = conn.cursor()
        cond = []
        val = []
        ...
        q = "SELECT * FROM listfo11 WHERE " + " AND ".join(cond) if cond else "SELECT * FROM listfo11"
    ...
    def openExtractionWindow(self): 
        from he7 import UI_ExtractionWindow  # Local import to avoid circular import
