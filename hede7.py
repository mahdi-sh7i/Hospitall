...
class UI_DeptmentWindow(QMainWindow):
    ...
    def clicker_display(self):
        ...
        conn = sqlite3.connect('/home/mahdi/project/formdb/fo13.db')  # Use the full path
        cur = conn.cursor()
        cond = []
        val = []
        ...
        q = "SELECT * FROM listfo13 WHERE " + " AND ".join(cond) if cond else "SELECT * FROM listfo13"
