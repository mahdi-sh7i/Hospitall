...
class UI_AdmisionWindow(QMainWindow):
    def __init__(self):  # Corrected method name to __init__
        super(UI_AdmisionWindow, self).__init__()  # Corrected superclass initialization
        self.center()  # Call to center method
        self.count = 0
        # Load the ui file
        uic.loadUi("Ehos_ajns.ui", self)
        # --------------------------------------------
...
if __name__ == "__main__":  # Corrected check to ensure this runs only when executed directly
    ...
    UIWindow = UI_AdmisionWindow()  # Create an instance of UI_AdmisionWindow
